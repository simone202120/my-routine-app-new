...
const SignupForm: React.FC = () => {
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      setError('Registrazione con Google fallita. Riprova più tardi.');
      console.error(err);
    } finally {
  ...
  return (
    <div className="mx-auto max-w-md w-full space-y-6 p-6 bg-white rounded-xl shadow-sm">
      <div className="text-center">
        ...
        <p className="text-gray-500 mt-2">Inizia a tracciare la tua routine quotidiana</p>
      </div>
      ...
      >
        ...
        {isGoogleLoading ? 'Connessione in corso...' : 'Registrati con Google'}
      </Button>
